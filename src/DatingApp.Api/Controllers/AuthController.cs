...
namespace DatingApp.Api.Controllers
{
    ...
    public class AuthController : CustomControllerBase
    {
        ...
        [HttpPut]
        public async Task<IActionResult> ChangePasssword(UserForChangePasswordDto userDto)
        {
          var user = await _userManager.FindByIdAsync(base.GetUserIdFromToken().ToString());
